...
using System.Text;
public class GenerateAnimationSocket : EditorWindow
{
    ...
    [MenuItem("Window/Generate Animation Socket")]
    public static void ShowWindow()
    {
        GenerateAnimationSocket window = (GenerateAnimationSocket)EditorWindow.GetWindow(typeof(GenerateAnimationSocket));
        window.minSize = new Vector2(400, 600);
        window.maxSize = new Vector2(400, 600);
        GetWindow<GenerateAnimationSocket>("Generate Animation Socket");
    }
    ...
    private void StartPythonServer()
    {
        ...
        pythonServerProcess = new Process
        {
            StartInfo = new ProcessStartInfo
            {
                ...
                Arguments = @"server.py", // Insert your server script here
