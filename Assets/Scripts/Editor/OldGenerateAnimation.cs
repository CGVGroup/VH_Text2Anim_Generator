...
public class OldGenerateAnimation : EditorWindow
{
    ...
    [MenuItem("Window/Old Generate Animation")]
    public static void ShowWindow()
    {
        OldGenerateAnimation window = (OldGenerateAnimation)EditorWindow.GetWindow(typeof(OldGenerateAnimation));
        window.minSize = new Vector2(400, 600);
        window.maxSize = new Vector2(400, 600);
        GetWindow<OldGenerateAnimation>("Old Generate Animation");
    }
